...
uint256 hashGenesisBlock("0x76ea3de193c4432393a770912e098cde872fed493df712fd8452ee668b86b9a4");
...
const string strMessageMagic = "ComradeCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // ComradeCoin: 1 days
static const int64 nTargetSpacing = 60; // ComradeCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal comradecoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ComradeCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1501505845; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 494673;

        if (fTestNet)
        {
            block.nTime    = 1501505845;
            block.nNonce   = 68049;
        }
